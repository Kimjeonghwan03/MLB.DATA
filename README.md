...
### 💡 리그 사무국 (MLB) 측면 
* **심판 판정 및 팬 시청 접근성 개선 시급**: Reddit 분석 결과, 팬들의 가장 큰 불만은 선수들의 기량이 아닌 '오심(Umpire)'과 내 돈 내고도 경기를 못 보는 '블랙아웃(Blackout)' 제도에 집중되어 있다. ABS(자동 투구 판정 시스템)의 메이저리그 조기 도입을 검토하고, 스트리밍 시대에 맞지 않는 낡은 지역 중계권 독점 조항을 개